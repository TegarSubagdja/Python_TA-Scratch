    ...
    while open_list:
        ...
        for dX, dY in [
            ...
            if current in came_from:
                tpf = TP(came_from[current], current, neighbour, 1)
            else:
                tpf = 0  # Start node tidak punya parent, jadi tidak ada penalti belok
            ...
            if tentative_gn < gn.get(
                ...
                fn[neighbour] = tentative_gn + heuristic(neighbour, goal, hchoice) + tpf
