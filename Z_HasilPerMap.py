...
for i in range(1, 6):
    ...
    # Baca file
    df = pd.read_excel(f'Excel/Validasi/Hasil_Pengujian_{map_name}_128_avg_length.xlsx', sheet_name='Panjang Jalur Real')
...
# Simpan ke CSV
gabungan.to_excel('hasil_gabungan_vertikal_panjang_jalur.xlsx', index=False)

print("Data berhasil disimpan ke 'hasil_gabungan_vertikal.csv'")
