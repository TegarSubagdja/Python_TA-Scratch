...
def run(show=False):
    ...
    pd.DataFrame(hasil_time).to_excel("waktu_512_Avg10_AllComb.xlsx", index=False)
    pd.DataFrame(hasil_path).to_excel("panjang_512_Avg10_AllComb.xlsx", index=False)
    pd.DataFrame(hasil_open).to_excel("openlist_512_Avg10_AllComb.xlsx", index=False)
    pd.DataFrame(hasil_close).to_excel("closelist_512_Avg10_AllComb.xlsx", index=False)
